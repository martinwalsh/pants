...
# source: files/config
# md5 sum: b0ec7742745e6492fce240703ca0eab7
borkfiles__ZmlsZXMvY29uZmlnCg=""
ok file ${PANTSDIR}/config files/config --permissions=755

# Include custom bork types
ok directory ${PANTSDIR}/types
# source: types/lineinfile.sh
# md5 sum: d27a19cbc5ecd4a5bf96565ddc13f599
borkfiles__dHlwZXMvbGluZWluZmlsZS5zaAo=""
ok file ${PANTSDIR}/types/lineinfile.sh types/lineinfile.sh
# source: types/fragment.sh
# md5 sum: 924256f5b278d0606072cfe595c68e9c
borkfiles__dHlwZXMvZnJhZ21lbnQuc2gK=""
